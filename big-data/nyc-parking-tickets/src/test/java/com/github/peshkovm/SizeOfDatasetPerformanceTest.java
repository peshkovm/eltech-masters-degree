...
public class SizeOfDatasetPerformanceTest {
  ...
  public static class ParallelInferenceState {
    private @Contended static final String DATASET_PATH =
        "nyc-parking-tickets/src/main/resources/nyc-parking-tickets.csv";

    public @Contended MultiLayerConfiguration conf;
  ...
  public static class NycParkingTicketsAccelerationTest {
    ...
    public Evaluation evaluate(final ParallelInferenceState state) {
      final int numLabelClasses = state.numLabelClasses;
      final DataSet testData = state.testData;
      final MultiLayerConfiguration conf = state.conf;
      final DataSet trainingData = state.trainingData;
  ...
  public static void main(String[] args) throws Exception {
    Options opt =
        new OptionsBuilder()
            .include(SizeOfDatasetPerformanceTest.class.getName())
