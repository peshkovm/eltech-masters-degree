...
void solve_jacobi_sequential(float **matrix, int matrix_size, const float *right_hand_side);

void solve_jacobi_parallel(float **matrix, int matrix_size, const float *right_hand_side);
